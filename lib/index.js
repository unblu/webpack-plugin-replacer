...
class Replacer {
    constructor(opts) {
        console.log("Unblu WebpackPluginReplacer (v5.0.3) created.");
        ...
        assetList.filter((file) => {
            ...
            if (this.options.sourceMap && asset.sourceAndMap) {
                ...
                for (const index in this.options.patterns) {
                    ...
                    if (file.endsWith(pattern.targetSuffix) || pattern.targetSuffix == undefined) {
                        console.log("Unblu WebpackPluginReplacer process file with pattern with sourcemap: ", file);
                        let match = null;
                ...
                for (const pattern of this.options.patterns) {
                    if (file.endsWith(pattern.targetSuffix) || pattern.targetSuffix == undefined) {
                        console.log("Unblu WebpackPluginReplacer process file with pattern: ", file);
